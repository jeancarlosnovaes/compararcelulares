<div class="table-responsive">
    <table class="table table-bordered table-hover" id="comments-table">
        <thead>
            <tr>
                <th>When Bought</th>
            ...
            <tr>
                ...
                <td>
                    ...
                    <div class='btn-group d-flex justify-content-center'>
                        <a href="{{ route('comments.show', [$comment->id]) }}" class='btn btn-outline-secondary btn-sm'>
                            <i class="fas fa-eye"></i>
                        </a>
                        <a href="{{ route('comments.edit', [$comment->id]) }}" class='btn btn-outline-secondary btn-sm'>
