<table class="table table-responsive" id="smartphones-table">
    <thead>
        <tr>
            <th>Product Name</th>
        <th>Product Image</th>
    ...
    @foreach($smartphones as $smartphone)
        <tr>
            ...
            <td>{!! $smartphone->product_image !!}</td>
            <td>{!! $smartphone->product_description !!}</td>
            <td>{!! $smartphone->brand_id !!}</td>
            ...
            <td>
                ...
                <div class='btn-group'>
                    <a href="{!! route('smartphones.show', [$smartphone->id]) !!}" class='btn btn-default btn-xs'><i class="glyphicon glyphicon-eye-open"></i></a>
                    <a href="{!! route('smartphones.edit', [$smartphone->id]) !!}" class='btn btn-default btn-xs'><i class="glyphicon glyphicon-edit"></i></a>
