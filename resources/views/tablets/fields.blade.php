...
<div class="form-group">
    ...
    <label class="checkbox-inline">
        ...
        {{ Form::checkbox('product_status',  true, true) }}
    </label>
</div>
...
<div class="form-group">
    ...
    <label class="checkbox-inline">
        ...
        {{ Form::checkbox('screen_toushscreen',  true, true) }}
    </label>
</div>
...
<div class="form-group">
    ...
    <label class="checkbox-inline">
        ...
        {{ Form::checkbox('screen_multitouch',  true, true) }}
    </label>
</div>
...
<div class="form-group">
    ...
    <label class="checkbox-inline">
        ...
        {{ Form::checkbox('screen_protect',  true, true) }}
    </label>
</div>
...
<div class="form-group">
    ...
    <label class="checkbox-inline">
        ...
        {{ Form::checkbox('memory_expandable',  true, true) }}
    </label>
</div>
...
<div class="form-group">
    ...
    <label class="checkbox-inline">
        ...
        {{ Form::checkbox('camera_stabilization',  true, true) }}
    </label>
</div>
...
<div class="form-group">
    ...
    <label class="checkbox-inline">
        ...
        {{ Form::checkbox('camera_autofocus',  true, true) }}
    </label>
</div>
...
<div class="form-group">
    ...
    <label class="checkbox-inline">
        ...
        {{ Form::checkbox('camera_touch',  true, true) }}
    </label>
</div>
...
<div class="form-group">
    ...
    <label class="checkbox-inline">
        ...
        {{ Form::checkbox('camera_zoom_optico',  true, true) }}
    </label>
</div>
...
<div class="form-group">
    ...
    <label class="checkbox-inline">
        ...
        {{ Form::checkbox('camera_HDR',  true, true) }}
    </label>
</div>
...
<div class="form-group">
    ...
    <label class="checkbox-inline">
        ...
        {{ Form::checkbox('camera_localization',  true, true) }}
    </label>
</div>
...
<div class="form-group">
    ...
    <label class="checkbox-inline">
        ...
        {{ Form::checkbox('camera_face_detection',  true, true) }}
    </label>
</div>
...
<div class="form-group">
    ...
    <label class="checkbox-inline">
        ...
        {{ Form::checkbox('camera_smile_detection',  true, true) }}
    </label>
</div>
...
<div class="form-group">
    ...
    <label class="checkbox-inline">
        ...
        {{ Form::checkbox('camera_4k',  true, true) }}
    </label>
</div>
...
<div class="form-group">
    ...
    <label class="checkbox-inline">
        ...
        {{ Form::checkbox('camera_panoramic',  true, true) }}
    </label>
</div>
...
<div class="form-group">
    ...
    <label class="checkbox-inline">
        ...
        {{ Form::checkbox('camera_zoom_digital',  true, true) }}
    </label>
</div>
...
<div class="form-group">
    ...
    <label class="checkbox-inline">
        ...
        {{ Form::checkbox('camera_dual',  true, true) }}
    </label>
</div>
...
<div class="form-group">
    ...
    <label class="checkbox-inline">
        ...
        {{ Form::checkbox('camera_exposure_compensation',  true, true) }}
    </label>
</div>
...
<div class="form-group">
    ...
    <label class="checkbox-inline">
        ...
        {{ Form::checkbox('camera_ISO',  true, true) }}
    </label>
</div>
...
<div class="form-group">
    ...
    <label class="checkbox-inline">
        ...
        {{ Form::checkbox('camera_macro',  true, true) }}
    </label>
</div>
...
<div class="form-group">
    ...
    <label class="checkbox-inline">
        ...
        {{ Form::checkbox('camera_manual_focus',  true, true) }}
    </label>
</div>
...
<div class="form-group">
    ...
    <label class="checkbox-inline">
        ...
        {{ Form::checkbox('camera_RAW',  true, true) }}
    </label>
</div>
...
<div class="form-group">
    ...
    <label class="checkbox-inline">
        ...
        {{ Form::checkbox('camera_scene_mode',  true, true) }}
    </label>
</div>
...
<div class="form-group">
    ...
    <label class="checkbox-inline">
        ...
        {{ Form::checkbox('camera_self_timer',  true, true) }}
    </label>
</div>
...
<div class="form-group">
    ...
    <label class="checkbox-inline">
        ...
        {{ Form::checkbox('camera_tactile_focus',  true, true) }}
    </label>
</div>
...
<div class="form-group">
    ...
    <label class="checkbox-inline">
        ...
        {{ Form::checkbox('camera_dual_rec',  true, true) }}
    </label>
</div>
...
<div class="form-group">
    ...
    <label class="checkbox-inline">
        ...
        {{ Form::checkbox('camera_video_photo',  true, true) }}
    </label>
</div>
...
<div class="form-group">
    ...
    <label class="checkbox-inline">
        ...
        {{ Form::checkbox('connectivity_USB_charging',  true, true) }}
    </label>
</div>
...
<div class="form-group">
    ...
    <label class="checkbox-inline">
        ...
        {{ Form::checkbox('connectivity_USB_mass_storage',  true, true) }}
    </label>
</div>
...
<div class="form-group">
    ...
    <label class="checkbox-inline">
        ...
        {{ Form::checkbox('connectivity_USB_proprietary',  true, true) }}
    </label>
</div>
...
<div class="form-group">
    ...
    <label class="checkbox-inline">
        ...
        {{ Form::checkbox('connectivity_SAR_europe',  true, true) }}
    </label>
</div>
...
<div class="form-group">
    ...
    <label class="checkbox-inline">
        ...
        {{ Form::checkbox('connectivity_SAR_america',  true, true) }}
    </label>
</div>
...
<div class="form-group">
    ...
    <label class="checkbox-inline">
        ...
        {{ Form::checkbox('connectivity_jack_audio',  true, true) }}
    </label>
</div>
...
<div class="form-group">
    ...
    <label class="checkbox-inline">
        ...
        {{ Form::checkbox('connectivity_radio_FM',  true, true) }}
    </label>
</div>
...
<div class="form-group">
    ...
    <label class="checkbox-inline">
        ...
        {{ Form::checkbox('connectivity_computer_sync',  true, true) }}
    </label>
</div>
...
<div class="form-group">
    ...
    <label class="checkbox-inline">
        ...
        {{ Form::checkbox('connectivity_NFC',  true, true) }}
    </label>
</div>
...
<div class="form-group">
    ...
    <label class="checkbox-inline">
        ...
        {{ Form::checkbox('connectivity_OTA_sync',  true, true) }}
    </label>
</div>
...
<div class="form-group">
    ...
    <label class="checkbox-inline">
        ...
        {{ Form::checkbox('connectivity_router',  true, true) }}
    </label>
</div>
...
<div class="form-group">
    ...
    <label class="checkbox-inline">
        ...
        {{ Form::checkbox('connectivity_UMA',  true, true) }}
    </label>
</div>
...
<div class="form-group">
    ...
    <label class="checkbox-inline">
        ...
        {{ Form::checkbox('connectivity_VoLTE',  true, true) }}
    </label>
</div>
...
<div class="form-group">
    ...
    <label class="checkbox-inline">
        ...
        {{ Form::checkbox('battery_fast_charging',  true, true) }}
    </label>
</div>
...
<div class="form-group">
    ...
    <label class="checkbox-inline">
        ...
        {{ Form::checkbox('battery_charging_wireless',  true, true) }}
    </label>
</div>
...
<div class="form-group">
    ...
    <label class="checkbox-inline">
        ...
        {{ Form::checkbox('function_music_player',  true, true) }}
    </label>
</div>
...
<div class="form-group">
    ...
    <label class="checkbox-inline">
        ...
        {{ Form::checkbox('function_video_player',  true, true) }}
    </label>
</div>
...
<div class="form-group">
    ...
    <label class="checkbox-inline">
        ...
        {{ Form::checkbox('function_TV',  true, true) }}
    </label>
</div>
...
<div class="form-group">
    ...
    <label class="checkbox-inline">
        ...
        {{ Form::checkbox('function_TV_output',  true, true) }}
    </label>
</div>
...
<div class="form-group">
    ...
    <label class="checkbox-inline">
        ...
        {{ Form::checkbox('function_flash_player',  true, true) }}
    </label>
</div>
...
<div class="form-group">
    ...
    <label class="checkbox-inline">
        ...
        {{ Form::checkbox('function_vibration',  true, true) }}
    </label>
</div>
...
<div class="form-group">
    ...
    <label class="checkbox-inline">
        ...
        {{ Form::checkbox('function_speakerphone',  true, true) }}
    </label>
</div>
...
<div class="form-group">
    ...
    <label class="checkbox-inline">
        ...
        {{ Form::checkbox('function_ringtones',  true, true) }}
    </label>
</div>
...
<div class="form-group">
    ...
    <label class="checkbox-inline">
        ...
        {{ Form::checkbox('function_custom_ringtones',  true, true) }}
    </label>
</div>
...
<div class="form-group">
    ...
    <label class="checkbox-inline">
        ...
        {{ Form::checkbox('sensor_accelerometer',  true, true) }}
    </label>
</div>
...
<div class="form-group">
    ...
    <label class="checkbox-inline">
        ...
        {{ Form::checkbox('sensor_proximity',  true, true) }}
    </label>
</div>
...
<div class="form-group">
    ...
    <label class="checkbox-inline">
        ...
        {{ Form::checkbox('sensor_gyroscope',  true, true) }}
    </label>
</div>
...
<div class="form-group">
    ...
    <label class="checkbox-inline">
        ...
        {{ Form::checkbox('sensor_compass',  true, true) }}
    </label>
</div>
...
<div class="form-group">
    ...
    <label class="checkbox-inline">
        ...
        {{ Form::checkbox('sensor_barometer',  true, true) }}
    </label>
</div>
...
<div class="form-group">
    ...
    <label class="checkbox-inline">
        ...
        {{ Form::checkbox('sensor_noise_reduction_microphone',  true, true) }}
    </label>
</div>
...
<div class="form-group">
    ...
    <label class="checkbox-inline">
        ...
        {{ Form::checkbox('sensor_ambient_light',  true, true) }}
    </label>
</div>
...
<div class="form-group">
    ...
    <label class="checkbox-inline">
        ...
        {{ Form::checkbox('sensor_fingerprint',  true, true) }}
    </label>
</div>
