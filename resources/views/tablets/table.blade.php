<div class="table-responsive">
        <table class="table table-bordered table-hover" id="tablets-table">
            <thead>
                <tr>
                    <th>Product Name</th>
                    <th>Product Image</th>
                ...
                <tr>
                    ...
                    <td>
                        ...
                        <div class='btn-group d-flex justify-content-center'>
                            <a href="{{ route('tablets.show', [$tablet->id]) }}" class='btn btn-outline-secondary btn-sm'>
                                <i class="fas fa-eye"></i>
                            </a>
                            <a href="{{ route('tablets.edit', [$tablet->id]) }}" class='btn btn-outline-secondary btn-sm'>
