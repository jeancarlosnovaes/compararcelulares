...
<section class="content">
    <header>
        <div class="image">
            <img src="../../storage/May-2018/apple-iphone-8.jpeg" alt="Apple Iphone 8">
        </div>
        <div class="title">
            <h2>Product Name</h2>
        </div>
    ...
    <div class="description">
        <p>Magna do voluptate ad minim excepteur esse Lorem sit aute fugiat in excepteur pariatur. Laborum laboris culpa reprehenderit
            excepteur laboris aliquip aute culpa ullamco magna. Do incididunt ex commodo proident duis est eu minim. Ea laboris
            deserunt eu nulla eu irure elit aliqua Lorem. Et non laboris ea aliqua labore reprehenderit non occaecat culpa.
            Exercitation exercitation est esse consequat qui do cupidatat. Ullamco nostrud irure id mollit aute eiusmod sint
            consectetur labore minim do. Cupidatat sunt nostrud sint ipsum laborum ullamco eu culpa excepteur id. Ut cupidatat
            consectetur excepteur dolor irure labore minim excepteur ex in officia cillum reprehenderit excepteur. Sint proident
            ad exercitation nulla nostrud reprehenderit officia voluptate. Quis in id aute ut eu. Sit ipsum elit incididunt
            commodo et consectetur anim cillum pariatur. Eu adipisicing duis ullamco cupidatat adipisicing voluptate eu excepteur
            excepteur. Cupidatat adipisicing consequat aute sint. Mollit veniam consequat ea sint officia consequat voluptate
            elit. Amet excepteur ipsum commodo cillum laborum nulla sint exercitation eu eu ex dolore eiusmod aliqua. Fugiat
            esse consectetur aliquip cillum aliqua ut duis exercitation cupidatat do. Elit Lorem eu ea officia nostrud id
            exercitation reprehenderit nisi. Adipisicing ea occaecat occaecat amet elit laboris sint cupidatat cupidatat
            commodo cupidatat ex eu.</p>
    </div>
    <div class="structure">
        <div class="title">
    ...
    <div class="power-hardware">
        <div class="title">
            <h3>Power and Hardware</h3>
        </div>
        <ul>
            <li>
                <div class="left">Left</div>
    ...
    <table class="table table-bordered table-hover" id="smartphone-table">
        ...
        <tbody>
            <tr>
                ...
                <td>
                    <img src="../{{ $smartphone->product_image }}" alt="{{ $smartphone->product_name }}">
                </td>
                <td>{{ $smartphone->product_description }}</td>
                {{--
                <td>{{ $smartphone[0]->brand->name}}</td>
