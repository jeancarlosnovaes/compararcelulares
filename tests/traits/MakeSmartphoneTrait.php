...
trait MakeSmartphoneTrait
{
    /**
     * Create fake instance of Smartphone and save it in database
     *
     * @param array $smartphoneFields
     * @return Smartphone
     */
    public function makeSmartphone($smartphoneFields = [])
    {
        /** @var SmartphoneRepository $smartphoneRepo */
        $smartphoneRepo = App::make(SmartphoneRepository::class);
        $theme = $this->fakeSmartphoneData($smartphoneFields);
        return $smartphoneRepo->create($theme);
    }

    /**
     * Get fake instance of Smartphone
     *
     * @param array $smartphoneFields
     * @return Smartphone
     */
    public function fakeSmartphone($smartphoneFields = [])
    {
        return new Smartphone($this->fakeSmartphoneData($smartphoneFields));
    }

    /**
     * Get fake data of Smartphone
     *
     * @param array $postFields
     * @return array
     */
    public function fakeSmartphoneData($smartphoneFields = [])
    {
        $fake = Faker::create();
